...
export const sites: MosaicSite[] = [
  ...
  { id: "keepsurfing", name: "KeepSurfing", category: "Portfolio", status: "En ligne", url: "https://keepsurfing.fr/", description: "Le portfolio de Florent Combes : sites, applications, extensions et jeux soignés.", tags: ["portfolio", "développeur", "projets"], addedAt: "18 sept. 2026", lastAccessed: "Aujourd’hui", accent: "#ff93d7", accentSecondary: "#9165ff", mark: "K" },
  { id: "rgpd-scan", name: "RGPD Scan", category: "Applications", status: "En ligne", url: "https://rgpd-scan.vercel.app/", description: "Un audit de conformité qui analyse cookies, scripts et traceurs avant consentement.", tags: ["RGPD", "audit", "SaaS"], addedAt: "18 sept. 2026", lastAccessed: "Aujourd’hui", accent: "#7bf0c1", accentSecondary: "#39a8d1", mark: "R" },
  { id: "vercel-project", name: "Erdos 64 · Vercel", category: "Déploiement", status: "En ligne", url: "https://vercel.com/keepsurfings-projects/erdos-64-dashboard/9FNRn2867umBSKHhjwVhhSpRLDAP", description: "Le déploiement Vercel associé au dashboard Erdos 64.", tags: ["Vercel", "production", "dashboard"], addedAt: "18 sept. 2026", lastAccessed: "Aujourd’hui", accent: "#e8ebeb", accentSecondary: "#7d8d97", mark: "V" },
  { id: "orientation", name: "Conseiller d’orientation", category: "Applications", status: "En ligne", url: "https://conseiller-orientation.vercel.app/", description: "Un outil pour découvrir des métiers adaptés à son profil grâce au quiz RIASEC.", tags: ["orientation", "RIASEC", "métiers"], addedAt: "18 sept. 2026", lastAccessed: "Aujourd’hui", accent: "#ffc2a2", accentSecondary: "#d969a1", mark: "C" },
];
